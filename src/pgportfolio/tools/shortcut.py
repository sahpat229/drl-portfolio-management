...
def execute_backtest(algo, config, history, window_size, trading_commission):
    """
    ...
    backtester = BackTest(config, agent=agent, agent_type=agent_type, net_dir=net_dir, history=history, window_size=window_size,
